    ...
    [336], {
        336: (e, t, n) => {
            ...
            const c = class {
                ...
                f = {
                    ...
                    rbac: {
                        ...
                        users: {
                            "Admin of gmail": new c([
                                ["admin", u.gmail]
                            ]),
                            "Reader of instagram": new c([
                                ["reader", u.instagram]
                            ])
                        }
                    },
                    advanced: {
                        ...
                        users: {
                            "Member of google": new c([
                                ["member", p.google]
                            ]),
                            "Owner of facebook": new c([
                                ["owner", p.facebook]
                            ]),
                            "Reader of search": new c([
                                ["reader", u.search]
                            ]),
            ...
            function w({
                ...
                return a.createElement("span", null, a.createElement(x, {
            ...
            function k({
                ...
                return a.createElement("div", {
                    ...
                    id: "4044204037"
                }, [".repo.jsx-4044204037{padding:0.5rem 0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}", ".public.jsx-4044204037{font-size:0.75rem;line-height:1rem;font-weight:400;color:rgb(75,85,99);border:1px solid rgb(209,213,219);border-radius:0.25rem;padding:0.125rem 0.25rem;margin-left:0.25rem;}", ".delete{color:white;background-color:rgb(190,24,93);}", ".delete:disabled{color:white;background-color:rgb(209,213,219);}"]), a.createElement("span", {
                    className: "jsx-4044204037"
                }, a.createElement(w, {
                    repo: e
                }), e.isPublic && a.createElement("span", {
                    className: "jsx-4044204037 public"
                }, "Public")), a.createElement(v, {
                    small: !0,
                    className: "delete",
                    disabled: !t
                }, "Delete"))
            ...
            function E(e) {
                return a.createElement("select", b({
                    style: {
                        color: "black",
                        border: "1px solid",
                        borderColor: g,
            ...
            function v({
                ...
                return a.createElement("button", b({
                    style: {
            ...
            function R() {
                ...
                (0, a.useEffect)((async () => {
                    if (!O) return;
                    let e = await Promise.all(Object.values(u).map((async e => {
                ...
                return a.createElement("div", {
                ...
                }, a.createElement(y, null, "Policy:"), a.createElement("div", {
                    className: "jsx-1298411406 ml-3"
                }, a.createElement(E, {
                    value: e,
                    onChange: e => t(e.target.value)
                }, Object.entries(f).map((([e, t]) => a.createElement("option", {
                    value: e,
                    key: e,
                    ...
                    className: "next",
                    onClick: () => t(p)
                }, "Next") : a.createElement("a", {
                    href: h,
                    className: "jsx-1298411406"
                }, a.createElement(v, {
                    className: "next"
                }, "Try it →")))), a.createElement("div", {
                    ...
                    language: "ruby",
                    style: l.Z
                }, o.displayPolar || o.polar), a.createElement("div", {
                    className: "jsx-1298411406 shadow"
                }))), a.createElement("div", {
                    className: "jsx-1298411406 demo-app-container"
                }, a.createElement("div", {
                    style: {
                        visibility: Object.keys(o.users).length > 1 ? "visible" : "hidden"
                    },
                    className: "jsx-1298411406 role-selector"
                }, a.createElement(y, null, "View as:"), a.createElement("div", {
                    className: "jsx-1298411406 ml-3"
                }, a.createElement(E, {
                    value: b,
                    onChange: e => R(e.target.value)
                }, Object.keys(o.users).map((e => a.createElement("option", {
                    key: e,
                    className: "jsx-1298411406"
                    ...
                    className: "jsx-1298411406"
                }, "gitclub.com")), a.createElement("div", {
                    className: "jsx-1298411406 demo-app-inner"
                }, a.createElement("div", {
                    className: "jsx-1298411406 sample-app-badge"
                }, "Sample app"), C.roles.length > 0 && a.createElement("div", {
                    className: "jsx-1298411406"
                }, a.createElement(y, null, "Roles"), a.createElement("div", {
            ...
            const O = "rgb(45, 43, 85)",
                _ = "#bc7ff5",
                A = "#a5ff90";
            l.Z.comment.color = _, l.Z.bold.color = _, l.Z.italic.color = A, l.Z.url.color = A, l.Z.url.textDecoration = "none", s.Z.registerLanguage("markdown", N.Z);
            const I = window.LEARN_MORE_URL || "#current-openings",
                M = e => a.createElement("h1", C({}, e, {
                    className: "jsx-2491313739 " + (e && null != e.className && e.className || "")
                }), e.children, a.createElement(r.default, {
                    id: "2491313739"
                }, ['h1.jsx-2491313739{font-size:1.25rem;line-height:1.75rem;margin:0;font-family:"Space Grotesk",-apple-system,BlinkMacSystemFont, "Segoe UI",Roboto,Oxygen,Ubuntu,Cantarell,"Open Sans", "Helvetica Neue",sans-serif;}']));
            ...
            function P(e) {
                return a.createElement("select", C({
                    style: {
                        color: "black",
                        border: "1px solid",
                        borderColor: O,
            ...
            const U = a.forwardRef((function({
                small: e,
                ...t
            }, n) {
                return a.createElement("button", C({
                    ref: n,
                    style: {
                        padding: e ? "0.2rem 0.6rem" : "0.25rem 0.75rem",
                        borderRadius: 4,
            ...
            function z() {
                ...
                }, a.createElement(M, null, "Value:"), a.createElement("div", {
                    className: "jsx-1043839301 select"
                }, a.createElement(P, {
                    value: t,
                    onChange: e => n(e.target.value)
                }, Object.entries(S).map((([e, t]) => a.createElement("option", {
                    value: e,
                    key: e,
            ...
            function Z(e, t, n, a, o, r, s) {
                const i = 1 - s,
                    ...
                    m = c * i,
                    d = l * s;
                return [m * e + 3 * c * s * n + 3 * i * l * o + d * o, m * t + 3 * c * s * a + 3 * i * l * r + d * r]
            }

            function D(e, t, n, a, o, r, s) {
                const [i, l] = function(e, t, n, a, o, r, s) {
                    return [2 * (n - e) * (1 - s) + s * (2 * (o - n)), 2 * (a - t) * (1 - s) + s * (2 * (r - a))]
                }(e, t, n, a, o, r, s), c = Math.sqrt(i * i + l * l);
                return [-l / c, i / c]
            }
            var H = n(7621),
                W = n.n(H);
            const $ = "#24da78",
                ...
                Y = ({
                    ...
                    if ("User" === t) {
                        ...
                        r.background = `linear-gradient(90deg, ${e} 0%, ${t} 100%)`, r.color = "#000", r.border = "1px solid transparent", n = n[0].toUpperCase() + n.slice(1), o = a.createElement(B._K$, {
                            style: {
                    ...
                    return "Repo" === t && (n = n[0].toUpperCase() + n.slice(1), o = a.createElement(F.aHI, {
                        style: {
                            verticalAlign: "text-top",
                            marginRight: 2
                        }
                    })), "Org" === t && (n = n[0].toUpperCase() + n.slice(1), o = a.createElement(F.swz, {
                        style: {
                            verticalAlign: "text-top",
                            marginRight: 2
                        }
                    })), "Issue" === t && (o = a.createElement(B.obJ, {
                        style: {
                            verticalAlign: "text-top",
                            marginRight: 2
                        }
                    }), n = "too heavy!"), a.createElement(a.Fragment, null, a.createElement("span", {
                        style: r
                    }, o || a.createElement("span", null, t, t && n && ":"), a.createElement("span", null, n)))
                },
                K = {
                ...
                ee = {};
            for (const e in K) {
                const t = "has_role" === (te = K[e])[0] ? "roles" : "has_parent" === te[0] && te[1].startsWith("Repo:") || "is_public" === te[0] ? "repos" : "has_parent" === te[0] || "is_locked" === te[0] || "has_creator" === te[0] ? "issues" : void 0;
            ...
            const ne = ({
                ...
                const r = X[t] || [];
                return a.createElement("div", null, e.map((e => a.createElement("div", {
                    key: e,
                    ref: o[e],
                    style: {
                        opacity: r.includes(e) ? 1 : .1,
                    ...
                    onClick: () => (e => {
                        let a = Object.entries(X).filter((([t, n]) => n.includes(e)));
            ...
            function ae() {
                const [e, t] = a.useState(null), [n, o] = a.useState(!1), r = Object.keys(Q), s = r.indexOf(e), i = r[(s + 1) % r.length];
                (0, a.useEffect)((() => {
                    if (!e) {
            ...
            const se = ({
                    ...
                    return (0, a.useEffect)((() => {
                        ...
                        const e = function(e, t, n) {
                            ...
                            let p = s,
                                u = n.y;
                            "center" === d ? [c, m] = [t.x + t.width / 2, t.y + t.height] : "right" === d ? [c, m] = [t.x + t.width, t.y + t.height / 2] : "left" === d && ([c, m] = [t.x, t.y + t.height / 2]);
                            ...
                            let b = () => {
                                ...
                                function t(t) {
                                    ...
                                    a.strokeStyle = "#fff", a.lineWidth = Math.min(n / 500 * 4, 4), a.beginPath(), a.shadowBlur = 10, a.shadowColor = "#eeeeffff";
                                    const r = e.width / 2,
                                        s = e.height / 2;
                                    let i, l, d, b;
                                    const g = Math.max(1 - n / 100, .05),
                                        h = Math.min(n / 200, .9);
                                    for (let y = g; y < h; y += .03) {
                                        const [x, w] = Z(c, m, r, s, p, u, y);

                                        function k() {
                                            const e = n / 500;
                                            return .6 * o[t](y, e) + .4 * o[t](8 * y, 8 * e)
                                        }
                                        const E = Math.sin((.9 * y + .1) * Math.PI),
                                            v = Math.min(6, n / 1e3 * 6) * E * E,
                                            j = k() * v,
                                            [R, N] = D(c, m, r, s, p, u, y);
                                        d = x + j * R, b = w + j * N, void 0 === i && (i = d, l = b, a.moveTo(x, w)), a.lineTo(d, b)
                                    }
                                    a.stroke(), a.stroke(), a.fillStyle = "#fff", a.beginPath(), a.arc(i, l, 5, 0, 2 * Math.PI), a.fill(), a.beginPath(), a.arc(d, b, 5, 0, 2 * Math.PI), a.fill()
                                }
                            };
                ...
                ie = ({
                    ...
                    toRef: t,
                    containerRef: n
                }) => a.createElement(a.Fragment, null, e.map(((e, o) => a.createElement(se, {
                    key: o,
                    fromRef: e,
                    toRef: t,
                    containerRef: n
                    ...
                    return a.createElement("div", {
                        ...
                        return o ? a.createElement("div", {
                            ...
                            style: {
                                position: "absolute",
                                opacity: "enter" === n ? 1 : 0,
                                transform: `translateY(${"from"===n?20:"leave"===n?-20:0}px) scaleY(${"enter"!==n?.4:1})`,
                                transition: "opacity 0.4s, transform 0.4s",
                                whiteSpace: "nowrap",
                                textShadow: "enter" === n ? "0 0 10px #ffffff99" : "none"
                            }
                        }, a.createElement(ce, {
                            output: o
                        })) : null
                ...
                ce = ({
                    ...
                    const t = "can" === e[1],
                        n = t ? `linear-gradient(90deg, ${W()($).darken(10)} 0%, ${W()($).darken(5)} 100%)` : `linear-gradient(90deg, ${W()(q).lighten(3)} 0%, ${W()(q).lighten(5)} 100%)`;
                    return a.createElement("div", {
                        style: {
                            display: "flex",
                            flexDirection: "column",
                    ...
                    }, a.createElement("span", null, a.createElement(Y, null, e[0]), " ", e[1], " ", a.createElement(Y, null, e[2]), " ", a.createElement(Y, null, e[3]))))
                },
                me = ({
                    fact: e
                }) => {
                    if ("has_role" === e[0]) {
                        ...
                        return a.createElement(a.Fragment, null, a.createElement(Y, null, e[1]), " is ", t, " ", a.createElement(Y, null, e[2]), " on ", a.createElement(Y, null, e[3]))
                    }
                    return "has_parent" === e[0] ? a.createElement(a.Fragment, null, a.createElement(Y, null, e[1]), " belongs to ", a.createElement(Y, null, e[2])) : "is_public" === e[0] ? a.createElement(a.Fragment, null, a.createElement(Y, null, e[1]), " is public") : "is_locked" === e[0] ? a.createElement(a.Fragment, null, a.createElement(Y, null, e[1]), " is locked") : "has_creator" === e[0] ? a.createElement(a.Fragment, null, a.createElement(Y, null, e[1]), " was created by ", a.createElement(Y, null, e[2])) : void 0
                };
            var de = n(3379),
                pe = n.n(de),
                ue = n(7795),
            ...
            je.styleTagTransform = Ee(), je.setAttributes = ye(), je.insert = ge().bind(null, "head"), je.domAPI = fe(), je.insertStyleElement = we(), pe()(ve.Z, je), ve.Z && ve.Z.locals && ve.Z.locals, window.process = void 0
        },
        2576: (e, t, n) => {
            n.d(t, {
                Z: () => i
